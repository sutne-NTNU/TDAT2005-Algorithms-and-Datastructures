...
{
    public final int NR;
    public String name; // hvis stedet har blitt navngitt
    public Road road;   // lenket liste med kanter fra denne noden
    ...
    public Node(int nr, double breddegrad_grd, double lengdegrad_grd)
    {
        this.NR = nr;
    ...
    public void newRoad(Road newRoad)
    {
        if (road == null)
        {
            road = newRoad;
