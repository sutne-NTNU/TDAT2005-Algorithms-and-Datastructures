...
//	Gjemnes–Kårvåg	          5108028	 5709083	        287	            0:40:41
	...
	public static void main(String[] args)
	{
		Graf island = null;
		Graf norden = null;
		System.out.print("write (" + string_Color("red" , "s") + ") to stop, or (" + string_Color("red" , "r") + ") to restart");

		while(loop)
		{
			try
			{
				System.out.println("\n\nChoose map: (" + string_Color("yellow" , "n") + ")norden or (" + string_Color("yellow" , "i") + ")island");
		...
		println_Color("red" , "Program was stopped");
	}
