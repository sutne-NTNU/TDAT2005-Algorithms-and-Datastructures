...
import static hjelp.ColorPrint.*;
import hjelp.Kø;
import hjelp.Program;
import static hjelp.Program.vent;
...
public class Vektet_Graf
{
	...
	Vektet_Graf(String filnavn)
	{
		...
		try
		{
			...
			print_Color("green" , HJØRNER.length + "\n");
		}
	...
	{
		println_Color("blue" , "\n" + filnavn);
		print_Color("gray" , "Maksimal flyt fra ");
		print_Color("yellow" , kilde + "");
		print_Color("gray" , " til ");
		print_Color("yellow" , sluk + "");
		print_Color("gray" , " med Edmund Karp\n");
		println_Color("def" , "Økning : Flytøkende vei");
	}
	...
	{
		print_Color("gray" , "Maksimal flyt ble ");
		println_Color("green" , MAKS_FLYT + "");
		resett_alt();
	}
